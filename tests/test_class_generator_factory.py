...
def test_initialize_class_registry():
    ...
    """
    class_registry = initialize_class_registry(SAMPLE_SCHEMA, START_REF)
...
def test_add_type_hints():
    ...
    """
    class_registry = initialize_class_registry(SAMPLE_SCHEMA, START_REF)
    class_registry_with_hints = add_type_hints(class_registry)
...
def test_populate_classes():
    ...
    class_registry = initialize_class_registry(SAMPLE_SCHEMA, START_REF)
    class_registry_with_hints = add_type_hints(class_registry)
    populated_class_registry = populate_classes(class_registry_with_hints)
